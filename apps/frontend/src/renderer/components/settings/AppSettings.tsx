...
export type AppSection = 'appearance' | 'display' | 'language' | 'agent' | 'paths' | 'templates' | 'integrations' | 'api-profiles' | 'plugins' | 'updates' | 'notifications' | 'developer';
...
const appNavItemsConfig: NavItemConfig<AppSection>[] = [
  ...
  { id: 'display', icon: Monitor, label: 'Display', description: 'UI scale and layout' },
  { id: 'language', icon: Globe, label: 'Language', description: 'Interface language' },
  { id: 'agent', icon: Bot, label: 'Agent Settings', description: 'Default model and framework' },
  { id: 'paths', icon: FolderOpen, label: 'Paths', description: 'Python and framework paths' },
  { id: 'templates', icon: LayoutTemplate, label: 'Templates', description: 'Project templates' },
  { id: 'integrations', icon: Key, label: 'Integrations', description: 'API keys & Claude accounts' },
  { id: 'api-profiles', icon: Server, label: 'API Profiles', description: 'Custom API endpoints' },
  { id: 'plugins', icon: Puzzle, label: 'Plugins', description: 'Manage boilerplate plugins' },
  { id: 'updates', icon: Package, label: 'Updates', description: 'Auto Claude updates' },
  { id: 'notifications', icon: Bell, label: 'Notifications', description: 'Alert preferences' },
  { id: 'developer', icon: Bug, label: 'Developer', description: 'Debug and development tools' }
];

const projectNavItemsConfig: NavItemConfig<ProjectSettingsSection>[] = [
  { id: 'general', icon: Settings2, label: 'General', description: 'Auto-Build and agent config' },
  { id: 'claude', icon: Key, label: 'Claude Auth', description: 'Claude authentication' },
  { id: 'linear', icon: Zap, label: 'Linear', description: 'Linear integration' },
  { id: 'github', icon: Github, label: 'GitHub', description: 'GitHub issues sync' },
  { id: 'gitlab', icon: GitLabIcon, label: 'GitLab', description: 'GitLab integration' },
  { id: 'memory', icon: Database, label: 'Memory', description: 'Graphiti memory backend' }
];
