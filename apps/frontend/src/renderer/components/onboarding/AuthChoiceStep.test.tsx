...
describe('AuthChoiceStep', () => {
  ...
  describe('API Key Button Handler', () => {
    ...
    it('should call onAPIKeyPathComplete when profile is created', async () => {
      ...
      // Force a re-render with updated profiles to trigger useEffect
      // This simulates React's state updates that happen when ProfileEditDialog saves
      rerender(
        <AuthChoiceStep
          onNext={mockGoToNext}
          onBack={mockGoToPrevious}
      ...
      await waitFor(() => {
        ...
        // - wasEmpty = true (ref was 0 when dialog opened)
